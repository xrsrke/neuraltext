...
# %% auto 0
__all__ = ['load_snippet', 'SyntheticWord', 'generate_random_sentence', 'SyntheticSentence']
...
# %% ../nbs/06_synthetic.ipynb 14
class SyntheticSentence:
    def __init__(
        self,
        # snippet_path: str,
        # n_channels: int # The number of channels in the electrode array
    ):
        self.vocabs = get_vocab()
    ...
    def _generate_character_probs(self, sentence: str) -> TensorType["seq_len"]:
    ...
    def _generate_character_signal(self, sentence):
